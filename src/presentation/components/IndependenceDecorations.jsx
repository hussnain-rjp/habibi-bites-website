...
export const IndependenceDecorations = () => {
  ...
  return (
    <div className="independence-theme-wrapper" style={{ pointerEvents: 'none', userSelect: 'none' }}>
      ...
      {/* Floating Pakistani Flag - Left Side */}
      <div 
        style={{
          position: 'fixed',
          top: '25%',
          ...
          zIndex: 9990,
          pointerEvents: 'none',
          animation: 'floatWaving 4.2s ease-in-out infinite'
        }}
      >
      ...
      {/* Floating Pakistani Flag - Right Side */}
      <div 
        style={{
          position: 'fixed',
          top: '35%',
          ...
          zIndex: 9990,
          pointerEvents: 'none',
          animation: 'floatWaving 4.8s ease-in-out infinite 0.8s'
        }}
      >
        <svg width="34" height="22" viewBox="0 0 36 24" fill="none" style={{ borderRadius: '3px', filter: 'drop-shadow(0 3px 6px rgba(0,0,0,0.4))' }}>
          <rect width="36" height="24" fill="#00401A" />
      ...
      {/* Green & White Balloons Cluster - Bottom Left */}
      <div 
        style={{
          position: 'fixed',
          bottom: '22px',
